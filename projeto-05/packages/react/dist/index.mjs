...
function Checkbox2(props) {
  return /* @__PURE__ */ jsx2(CheckboxRoot, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx2(CheckboxIndicator, { asChild: true, children: /* @__PURE__ */ jsx2(Check, { weight: "bold" }) }) }));
}
...
function MultiStep({ steps, currentStep = 1 }) {
  return /* @__PURE__ */ jsxs2(MultiStepContainer, { children: [
    ...
    /* @__PURE__ */ jsx3(Steps, { css: { "--steps-size": steps }, children: Array.from({ length: steps }, (_, i) => i + 1).map((step) => {
